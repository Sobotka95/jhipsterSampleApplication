...
import io.github.jhipster.application.repository.FileRepository;
...
public class FileResourceIntTest {
    ...
    public void createFile() throws Exception {
        ...
        assertThat(testFile.getExt()).isEqualTo(DEFAULT_EXT);
    }
    ...
    public void updateFile() throws Exception {
        ...
        assertThat(testFile.getExt()).isEqualTo(UPDATED_EXT);
    }
